            ...
            <div class="col-8">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$brand->id}}</td>
                            <td class="text-danger">{{$brand->name}}</td>
                            ...
                            <td>
                                 ...
                                 <a href="/brands/{{$brand->id}}/edit" type="button" title="Edit {{$brand->name}} " class="btn btn-sm btn-success">
                                    Edit
                                </a>

                                <!-- Button trigger modal -->
                                <button type="button" title="Delete {{$brand->name}} " class="btn btn-sm btn-danger" data-toggle="modal" data-target="#exampleModal{{$brand->id}}">
                                    X
                                </button>
                                ...
                                <div class="modal fade" id="exampleModal{{$brand->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        Are You Sure You want To delete <b class="text-danger"> {{$brand->name}}  </b> ?
                                        </div>
                                        <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                        <a href="/brands/delete/{{$brand->id}}" type="button" class="btn btn-danger">Delete</a>
                                        </div>
                                    </div>
                                    </div>
                                </div>
