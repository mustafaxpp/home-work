                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                 ...
                                 <a href="/products/{{$product->id}}/edit" type="button" title="Edit {{$product->name}} " class="btn btn-sm btn-success">
                                    Edit
                                </a>

                                <!-- Button trigger modal -->
                                <button type="button" title="Delete {{$product->name}} " class="btn btn-sm btn-danger" data-toggle="modal" data-target="#exampleModal{{$product->id}}">
                                    X
                                </button>
                                ...
                                <div class="modal fade" id="exampleModal{{$product->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        Are You Sure You want To delete <b class="text-danger"> {{$product->name}}  </b> ?
                                        </div>
