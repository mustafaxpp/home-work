    ...
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse d-flex justify-content-center" id="collapsibleNavId">
            <ul class="navbar-nav mt-2 mt-lg-0 ">
                ...
                <li class="nav-item active">
                    <a class="nav-link active" href="/employees">Employees <span class="sr-only"></span></a>
                </li>
                <li class="nav-item">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <!-- Button trigger modal -->
                                    <button type="button" title="Delete {{$employee->name}} " class="btn btn-sm btn-danger" data-toggle="modal" data-target="#exampleModal{{$item->id}}">
                                        X
                                    </button>
                                    ...
                                    <div class="modal fade" id="exampleModal{{$employee->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <a href="/categories/delete/{{$employee->id}}" type="button" class="btn btn-danger">Delete</a>
                                            </div>
                                        </div>
                                        </div>
                                    </div>
